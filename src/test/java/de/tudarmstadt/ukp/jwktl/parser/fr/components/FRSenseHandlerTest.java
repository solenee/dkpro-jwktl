...
/**
 * Test case for {@link FRSenseHandler}.
 * @author Christian M. Meyer
 */
public class FRSenseHandlerTest extends FRWiktionaryEntryParserTest {
	...
	public void testManga() throws Exception {
		...
		assertEquals("{{BD|fr}} [[bande dessinée|Bande dessinée]] [[japonais]]e, souvent en noir et blanc.", senseIter.next().getGloss().getText());
		assertTrue(senseIter.hasNext());
		assertEquals("Style, stéréotypes et règles implicites de la bande dessinée japonaise.", senseIter.next().getGloss().getText());
		assertTrue(senseIter.hasNext());
		assertEquals("[[dessin animé|Dessin animé]] japonais ; [[anime#fr|anime]].", senseIter.next().getGloss().getText());
