...
/**
 * Abstract test case for French Wiktionary parsers.
 * @author Solene Eholie
 */
public abstract class FRWiktionaryEntryParserTest extends TestCase {

	protected IWiktionaryPage parse(final String fileName) throws IOException {
		StringBuilder text = new StringBuilder();
		BufferedReader reader = new BufferedReader(
				new InputStreamReader(new FileInputStream(
						new File("src/test/resources/articles-fr/" + fileName)), 
						"UTF-8"));
		String line;
		...
		WiktionaryEntryParser parser = new FRWiktionaryEntryParser();
