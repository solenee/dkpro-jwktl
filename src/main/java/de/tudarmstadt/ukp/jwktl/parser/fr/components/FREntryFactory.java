...
public class FREntryFactory extends EntryFactory {
	...
	static {
		//https://fr.wiktionary.org/wiki/Wiktionnaire:Liste_de_tous_les_mod%C3%A8les/Titres_de_sections/Liste_automatique#Sections_normales
		posMap = new TreeMap<>();
		//posMap.put("ABBREVIATION", PartOfSpeech.ABBREVIATION); //SEH : ==== {{S|abréviations}} ====; ==== {{S|abrév}} ====
		//posMap.put("ACRONYM", PartOfSpeech.ACRONYM);
		posMap.put("ADJ", PartOfSpeech.ADJECTIVE); // SEH : aussi adj-*
		...
		posMap.put("NOM", PartOfSpeech.NOUN); //SEH
		...
		posMap.put("VERBE", PartOfSpeech.VERB);//SEH
